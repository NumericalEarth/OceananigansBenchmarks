    ...
    "Oceananigans.jl Benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "id": "b9d3dc656a91f634f9c8b22d89879ba2516a28a3",
          "message": "Support tracers in `PerturbationAdvection` open boundary conditions (#5617)\n\nCo-authored-by: Claude Opus 4.7 (1M context) <noreply@anthropic.com>\nCo-authored-by: Gregory L. Wagner <wagner.greg@gmail.com>",
          "timestamp": "2026-05-28T00:14:58Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/b9d3dc656a91f634f9c8b22d89879ba2516a28a3"
        },
        "date": 1779932561185,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "Grid Type Sweep/360x180x50 F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/immersed_lat_lon",
            "value": 0.057612202220000006,
            "unit": "s/timestep"
          },
          {
            "name": "Tracer Count Sweep/tripolar 360x180x50 F64 CATKE/NVIDIA TITAN V/3 tracers",
            "value": 0.060136403969999995,
            "unit": "s/timestep"
          },
          {
            "name": "Resolution Sweep/tripolar F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/360x180x50",
      ...
      },
      {
        "commit": {
          ...
          "id": "901b2c046d04557112fa8edfc53ce6174014f251",
          "message": "Regularize correctly `U` and `V` bc for a `TripolarGrid` (#5633)\n\n* correct\n\n* fix trailing whitespace\n\n---------\n\nCo-authored-by: Benoît Pasquier <4486578+briochemc@users.noreply.github.com>\nCo-authored-by: Taimoor Sohail <tsohail@spartan-bm131.hpc.unimelb.edu.au>",
          "timestamp": "2026-05-28T08:25:05Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/901b2c046d04557112fa8edfc53ce6174014f251"
        },
        "date": 1779961967459,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "b6043d321a5646220ff8e1a464729dcfa4233a7a",
          "message": "Update number of ambiguities (#5640)\n\nAlso, check for exact equality, so that we remember to update the cap as soon as\nnew ambiguities are fixed.",
          "timestamp": "2026-05-29T01:42:33Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/b6043d321a5646220ff8e1a464729dcfa4233a7a"
        },
        "date": 1780024289586,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "4f182a1a413587a6c8d8e6f52af9a027d284b0d3",
          "message": "(0.109.1) Fix `_fractional_indices` ambiguities and adapt `last_Δt` and `last_stage_Δt` to kernel time (#5634)\n\n* Update clock.jl\n\n* Bump version from 0.109.0 to 0.109.1\n\n* Use time_step_type(KT) when adapting Clock Δt fields\n\nWhen `Clock(time=DateTime(...))` is adapted to a kernel, `kernel_time_type`\nis `DateTime` but `last_Δt`/`last_stage_Δt` are `Float64` (seconds).\n`convert(::Type{DateTime}, ::Float64)` is not defined, so kernel launches\nthrough DateTime clocks fail with a `MethodError`.\n\nRoute the Δt fields through `time_step_type(KT)` instead — that returns\n`KT` for numeric clocks (so Float32 grids still get Float32 Δt) and\n`Float64` for `AbstractTime` clocks (matching how Δt is stored).\n\nCo-Authored-By: Claude Opus 4.7 (1M context) <noreply@anthropic.com>\n\n* Fix _fractional_indices arity dispatch for reduced-source set!\n\n`set!(::Field, ::Field)` routes to `interpolate!` when sizes or locations\ndon't match (introduced in #5586). For a destination at (Center,Center,Center)\non a (Bounded,Flat,Bounded) grid and a reduced source at (Nothing,Nothing,Center),\nthe kernel passes `flatten_node`'s 2-tuple `(x, z)` into\n`_fractional_indices(at, grid, nothing, nothing, ℓz)`.\n\nThe intended method here is the 1-tuple `(z,)` version (which would recurse\ncorrectly), but Julia's function-arg destructuring is permissive: the pattern\n`(z,)` happily binds to the first element of a longer tuple. So the dispatcher\npicked the 1-tuple branch and ran `fractional_z_index(x_value, ...)`, producing\na kk far outside the source's z range. The resulting interior wrote garbage\nmemory (and NaN past the end), which then poisoned every downstream\n`set!(model; ρ=ref.density)` and triggered `DomainError` in any subsequent\n`θ^γ` in compressible thermodynamics.\n\nTwo-part fix:\n- Add explicit `::NTuple{1, Any}` / `::NTuple{2, Any}` / `::NTuple{3, Any}`\n  constraints to every `_fractional_indices` method so the dispatcher cannot\n  silently bind a longer tuple to a shorter pattern.\n- Add three 2-tuple \"pruning\" methods for the cases where the source has more\n  `Nothing` locations than the destination has `Flat` dims — they mirror the\n  3-tuple recursive prunes at lines 228/231/234 but for the case where\n  `to_grid`'s `flatten_node` already produced a 2-tuple.\n\nCo-Authored-By: Claude Opus 4.7 (1M context) <noreply@anthropic.com>\n\n* fix CI\n\n* add method to reduce ambiguities\n\nreduces ambiguities from 323 to 317\n\n* reduce/remove _fractional_indices ambiguities\n\n* undo\n\n* Update test/test_quality_assurance.jl\n\nCo-authored-by: Mosè Giordano <765740+giordano@users.noreply.github.com>\n\n* Update test/test_quality_assurance.jl\n\n* Update test_quality_assurance.jl\n\n---------\n\nCo-authored-by: Navid C. Constantinou <navidcy@users.noreply.github.com>\nCo-authored-by: Gregory Wagner <greg@aeolus.earth>\nCo-authored-by: Claude Opus 4.7 (1M context) <noreply@anthropic.com>\nCo-authored-by: Gregory L. Wagner <wagner.greg@gmail.com>\nCo-authored-by: Mosè Giordano <765740+giordano@users.noreply.github.com>",
          "timestamp": "2026-05-29T02:03:16Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/4f182a1a413587a6c8d8e6f52af9a027d284b0d3"
        },
        "date": 1780029568676,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "Resolution Sweep/tripolar F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/180x90x50",
            "value": 0.030571174320000002,
            "unit": "s/timestep"
          },
          {
            "name": "Resolution Sweep/tripolar F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/720x360x50",
            "value": 0.21502138112000002,
            "unit": "s/timestep"
          },
          {
            "name": "Float Type Sweep/tripolar 360x180x50 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/F32",
          ...
          {
            "name": "Grid Type Sweep/360x180x50 F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/immersed_lat_lon",
            "value": 0.057609497970000006,
            "unit": "s/timestep"
          },
          {
            "name": "Tracer Count Sweep/tripolar 360x180x50 F64 CATKE/NVIDIA TITAN V/3 tracers",
            "value": 0.060265791990000005,
            "unit": "s/timestep"
          },
          {
            "name": "Resolution Sweep/tripolar F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/360x180x50",
      ...
      },
      {
        "commit": {
          "author": {
            ...
            "username": "rafmudaf",
            "email": "rafael@clementinescientific.com"
          },
          "committer": {
            "name": "GitHub",
            "username": "web-flow",
          ...
          "id": "f246b9d215eba6cd3940c072323af19d39c81f8e",
          "message": "Only trap target extension for auto_extension (#5644)\n\nAvoids passing through other extensions that might be intentionally or unintentionally included. This should usually be handled by the calling code rather than pass through.",
          "timestamp": "2026-05-29T15:04:45Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/f246b9d215eba6cd3940c072323af19d39c81f8e"
        },
        "date": 1780072541604,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "Float Type Sweep/tripolar 360x180x50 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/F32",
            "value": 0.04370430007000001,
            "unit": "s/timestep"
          },
          {
            "name": "Closure Sweep/tripolar 360x180x50 F64 WENOVectorInvariantDefault+WENO7/NVIDIA TITAN V/nothing",
            "value": 0.032562758989999996,
            "unit": "s/timestep"
          },
          {
            "name": "Closure Sweep/tripolar 360x180x50 F64 WENOVectorInvariantDefault+WENO7/NVIDIA TITAN V/CATKE+Biharmonic",
            "value": 0.08149536274000001,
            "unit": "s/timestep"
          },
          {
            "name": "Closure Sweep/tripolar 360x180x50 F64 WENOVectorInvariantDefault+WENO7/NVIDIA TITAN V/CATKE+GM+Biharmonic",
      ...
      },
      {
        "commit": {
          ...
          "id": "85c56cadfa35dff84df143a422ff01690caf8fa1",
          "message": "(0.109.2) Apply tracer open boundary conditions in `NonhydrostaticModel` (#5646)\n\nCo-authored-by: Claude Opus 4.7 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-06-01T00:04:30Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/85c56cadfa35dff84df143a422ff01690caf8fa1"
        },
        "date": 1780277614887,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "9b8a4471605ca866552dc4b7423ee5c66bb7c2b1",
          "message": "add zarr writer and chunk size as option to io benchmark (#5638)",
          "timestamp": "2026-06-01T15:34:06Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/9b8a4471605ca866552dc4b7423ee5c66bb7c2b1"
        },
        "date": 1780333715472,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "Float Type Sweep/tripolar 360x180x50 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/F32",
            "value": 0.044264802889999996,
            "unit": "s/timestep"
          },
          {
            "name": "Closure Sweep/tripolar 360x180x50 F64 WENOVectorInvariantDefault+WENO7/NVIDIA TITAN V/nothing",
            "value": 0.032322517440000004,
            "unit": "s/timestep"
          },
          {
            "name": "Closure Sweep/tripolar 360x180x50 F64 WENOVectorInvariantDefault+WENO7/NVIDIA TITAN V/CATKE+Biharmonic",
      ...
      },
      {
        "commit": {
          ...
          "id": "592e56488473b685b9c4b64f232ff2088ac465b6",
          "message": "(0.110.0) Rename `Open` → `NormalFlow` and add a `scheme` to `Value` (#5648)\n\n* Rename `Open` → `NormalFlow` and add a `scheme` to `Value`\n\nRestores the historical `NormalFlow` classification name (see #703, #848,\n#1140, #1156) for the boundary-normal-velocity boundary condition, and\ngeneralizes the matching-scheme slot to `Value` per #5647.\n\nBreaking changes:\n- The `Open` classification is renamed to `NormalFlow` and the `Open` symbol\n  is no longer exported. The public `OpenBoundaryCondition(val; scheme)`\n  constructor is unchanged (it now builds `NormalFlow(scheme)`), as is\n  `ImpenetrableBoundaryCondition`.\n- `Value` is now parametric (`Value{MS}`) with an optional `scheme`.\n  `ValueBoundaryCondition(val; scheme=nothing)` gains the keyword.\n- Tracer (Center-located) `PerturbationAdvection` open boundaries move from\n  `Open`/`NormalFlow` to `Value{<:PerturbationAdvection}`. Use\n  `ValueBoundaryCondition(c; scheme=PerturbationAdvection())` for tracers;\n  `OpenBoundaryCondition(u; scheme=…)` remains for boundary-normal velocities.\n\nAlso incorporates the #5646 bugfix (apply tracer open boundary conditions in\n`NonhydrostaticModel`) so this PR can supersede it: velocity and tracer halos\nare filled separately in the Nonhydrostatic `update_state!`, and because\ntracer radiation now lives on `Value` (ungated by `fill_open_bcs`) it fires\nduring the regular halo fill.\n\nOther changes:\n- Rename src/BoundaryConditions/fill_halo_regions_open.jl →\n  fill_halo_regions_normal_flow.jl.\n- Fix a latent invariant alias `BoundaryCondition{Value}` →\n  `BoundaryCondition{<:Value}` in immersed_diffusive_fluxes.jl that would\n  otherwise stop matching once `Value` became parametric.\n- Migrate tests, the tracer_outflow validation, and docs.\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>\n\n* Address review: fill_normal_flow_bcs (single merged fill), rename OBC→NFBC and PA aliases\n\nFollows up on the #5646 review note (discussion r3330106563): splitting the\nNonhydrostaticModel halo fill into two `fill_halo_regions!` calls costs extra\nkernel launches. Renames the gating keyword `fill_open_bcs` →\n`fill_normal_flow_bcs` so it targets the boundary-normal-velocity (NormalFlow)\nfills specifically, and collapses the update back into a single merged\nvelocity+tracer `fill_halo_regions!(...; fill_normal_flow_bcs=false)` call:\nvelocity NormalFlow fills are deferred, while tracer `Value` fills (which are\nnot gated) still fire.\n\nAlias renames requested in review:\n- `OBC`            → `NFBC`   (BoundaryCondition{<:NormalFlow})\n- PA Face alias    → `PANFBC` (was NormalFlowPA)\n- PA Center alias  → `PAVBC`  (was ValuePA)\n\nAlso converts the Nonhydrostatic tracer regression test to a `Value`-BC test\n(the supported tracer pattern), checking the value-extrapolation halo fill runs\nduring the merged update_state!.\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>\n\n* Apply suggestions from code review\n\nCo-authored-by: Tomás Chor <tomaschor@gmail.com>\n\n* fix alignment\n\n* update validation scripts\n\n* update docs and some comments\n\n* get rid of Open in a few more places\n\n* Open -> NormalFlow in tests\n\n* update boundary_tranport.jl\n\n* fix doc\n\n* rename PolarOpenBonudaryCondition\n\n---------\n\nCo-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com>\nCo-authored-by: tomaschor <tomaschor@gmail.com>",
          "timestamp": "2026-06-02T03:52:24Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/592e56488473b685b9c4b64f232ff2088ac465b6"
        },
        "date": 1780377722121,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "Closure Sweep/tripolar 360x180x50 F64 WENOVectorInvariantDefault+WENO7/NVIDIA TITAN V/nothing",
            "value": 0.032355440230000004,
            "unit": "s/timestep"
          },
          {
            "name": "Closure Sweep/tripolar 360x180x50 F64 WENOVectorInvariantDefault+WENO7/NVIDIA TITAN V/CATKE+Biharmonic",
            "value": 0.08150210056000001,
            "unit": "s/timestep"
          },
          {
            "name": "Closure Sweep/tripolar 360x180x50 F64 WENOVectorInvariantDefault+WENO7/NVIDIA TITAN V/CATKE+GM+Biharmonic",
      ...
      },
      {
        "commit": {
          ...
          "id": "7584814d760f6ebafdbc21953d8a7c01a3d55bfd",
          "message": "Add target_transport to PerturbationAdvection for per-boundary transport control (#5479)\n\nCo-authored-by: Claude Sonnet 4.6 <noreply@anthropic.com>\nCo-authored-by: Gregory L. Wagner <wagner.greg@gmail.com>\nCo-authored-by: Claude Opus 4.6 <noreply@anthropic.com>\nCo-authored-by: Claude Opus 4.7 (1M context) <noreply@anthropic.com>\nCo-authored-by: Claude Opus 4.7 <noreply@anthropic.com>\nCo-authored-by: copilot-swe-agent[bot] <198982749+Copilot@users.noreply.github.com>",
          "timestamp": "2026-06-02T16:43:54Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/7584814d760f6ebafdbc21953d8a7c01a3d55bfd"
        },
        "date": 1780424956457,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "8fd80a84362ddb5e5cd2aa85e2f42786542c4b69",
          "message": "Allow set! to copy between reduced and windowed single-layer fields (#5652)\n\n`set!(u::Field, v::Field)` routes to `interpolate!` whenever\n`matching_field_discretization(u, v)` is false. For a reduced field (e.g.\n`(Face, Center, Nothing)`) set from a windowed single-layer field (e.g.\n`(Face, Center, Center)` with `indices = (:, :, Nz:Nz)`) the sizes match but the\nz-location (`Nothing` vs `Center`) and index (`:` vs `Nz:Nz`) differ, so this was\ndeclared \"not matching\" and routed to `interpolate!`, which cannot bridge a\n2-coordinate node against a 3-location source and errors with a `_fractional_indices`\nMethodError.\n\nA `Nothing` dimension carries no node, so in a singleton dimension there is nothing\nto interpolate to and the single slab should simply be copied. Relax\n`matching_field_discretization` to treat a reduced (`Nothing`) location in a size-1\ndimension as matching regardless of the other field's location or index, while\npreserving the location+index check for all genuinely located dimensions (so e.g.\ntwo `Center` single-layer fields windowed at different levels still interpolate).\n\nCo-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-06-03T04:55:09Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/8fd80a84362ddb5e5cd2aa85e2f42786542c4b69"
        },
        "date": 1780467924500,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "12c4caf7060a297b8d443bd2c90077410d9fa907",
          "message": "Update Project.toml (#5653)",
          "timestamp": "2026-06-03T04:55:45Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/12c4caf7060a297b8d443bd2c90077410d9fa907"
        },
        "date": 1780473357050,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "5494227cc4eb017f60550e8a7b1cb272c7ef8766",
          "message": "Add `inactive_nodes` to `NetCDFWriter`'s `gather_immersed_boundary` (#5658)",
          "timestamp": "2026-06-06T16:44:44Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/5494227cc4eb017f60550e8a7b1cb272c7ef8766"
        },
        "date": 1780769809024,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "3c39858a729f0fa47fdc0f3be2a0ca091f5a6e28",
          "message": "Update `Diagnostics.cell_diffusion_timescale` method for vertically-implicit treatment (#5642)\n\n* update Diagnostics.cell_diffusion_timescale method for vertically-implicit treatment\n\n* apply taimoor's suggestions\n\n* Update src/TurbulenceClosures/turbulence_closure_diagnostics.jl\n\nCo-authored-by: Gregory L. Wagner <wagner.greg@gmail.com>\n\n* diffusive cfl for more closures\n\n* Fix diffusive CFL diagnostics for vertical closures\n\n* cleanup\n\n---------\n\nCo-authored-by: Gregory L. Wagner <wagner.greg@gmail.com>",
          "timestamp": "2026-06-07T08:20:00Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/3c39858a729f0fa47fdc0f3be2a0ca091f5a6e28"
        },
        "date": 1780825929854,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "ff43e4137876bb415b969b8ff6443813b21fb825",
          "message": "add ::Nothing methods to avoid type piracy in other packages (#5661)",
          "timestamp": "2026-06-08T10:59:13Z",
          "url": "https://github.com/CliMA/Oceananigans.jl/commit/ff43e4137876bb415b969b8ff6443813b21fb825"
        },
        "date": 1780922027802,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "Grid Type Sweep/360x180x50 F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/tripolar_zstar",
            "value": 0.06286350707999999,
            "unit": "s/timestep"
          },
          {
            "name": "Grid Type Sweep/360x180x50 F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/lat_lon",
            "value": 0.057341852299999996,
            "unit": "s/timestep"
          },
          {
            "name": "Grid Type Sweep/360x180x50 F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/immersed_lat_lon",
            "value": 0.057597664560000005,
            "unit": "s/timestep"
          },
          {
            "name": "Tracer Count Sweep/tripolar 360x180x50 F64 CATKE/NVIDIA TITAN V/3 tracers",
            "value": 0.06020427405999999,
            "unit": "s/timestep"
          },
          {
            "name": "Resolution Sweep/tripolar F64 WENOVectorInvariantDefault+WENO7 CATKE/NVIDIA TITAN V/360x180x50",
